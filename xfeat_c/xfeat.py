...
from xfeat_c.model import *
from xfeat_c.interpolator import InterpolateSparse2d
...
class XFeat(nn.Module):
	...
	def __init__(self, weights = '/Users/saptarshiMT/Music/meshsense/xfeat_c/xfeat.pt', top_k = 4096, detection_threshold=0.05):
		super().__init__()
